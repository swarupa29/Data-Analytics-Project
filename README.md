...
## Description of folders and files in the repository
 ...
 2. outputs - This folder stores all the output csv generated by the Level 0 models on each table (predictions on train and test data) as well as the prediction of the final model which was submitted to kaggle.
